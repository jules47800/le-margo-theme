...
<main id="primary" class="site-main thank-you-page">
    <div class="thank-you-container">
        ...
        <div class="thank-you-header">
            ...
            <h1><?php _e('Votre demande a bien été reçue !', 'le-margo'); ?></h1>
            <p class="subtitle"><?php _e('Nous avons hâte de vous accueillir au Margo.', 'le-margo'); ?></p>
        </div>
        
        <div class="thank-you-content">
            <div class="confirmation-details">
                <p><?php _e('Un email de confirmation vient de vous être envoyé avec les détails de votre demande. Nous la traiterons dans les plus brefs délais.', 'le-margo'); ?></p>
                <p><?php _e('Pensez à vérifier votre dossier de courriers indésirables (spam) si vous ne le trouvez pas.', 'le-margo'); ?></p>
            </div>
            
            <div class="next-steps">
                <p><?php _e('En cas de question ou de modification, n\'hésitez pas à nous appeler :', 'le-margo'); ?></p>
        ...
        <div class="back-home-link">
            <a href="<?php echo esc_url(home_url('/')); ?>" class="home-button">&larr; <?php _e('Retour à l\'accueil', 'le-margo'); ?></a>
        </div>
